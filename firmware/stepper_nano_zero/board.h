...
#define NZS_A1333_PIPELINE //does a pipeline read of encoder, which is slightly faster
...
#define VERSION "Ver:1.00" //this is what prints on LCD during splash screen
...
#define PIN_A1333_PWR	(11) //pull low to power on A1333
#endif
...
static void boardSetupPins(void)
{
	...
	pinMode(PIN_A1333_CS,OUTPUT);
	digitalWrite(PIN_A1333_CS,LOW); //pull CS LOW by default (chip powered off)

	//turn the A1333 off by default
#ifdef PIN_A1333_PWR
	pinMode(PIN_A1333_PWR,OUTPUT);
	digitalWrite(PIN_A1333_PWR,HIGH);
#endif
